// ============================================================================
// File: Custom/Engineering/Grenadier/Bombs/Poison/PoisonCloudBomb.cs
// ============================================================================
using System;
...
{
    public partial class PoisonCloudBomb : Item
    {
        ...
        [Constructable]
        public PoisonCloudBomb() : base(0xF0D)
        {
            Hue = 2511;
            Weight = 1.0;
            Name = "Poison Cloud Bomb";
        }

        public PoisonCloudBomb(Serial s) : base(s) { }

        public virtual int MinDamage { get { return 45; } }
        public virtual int MaxDamage { get { return 85; } }

        public override void Serialize(GenericWriter w) { base.Serialize(w); w.Write(0); w.Write(_nextUse); }
        public override void Deserialize(GenericReader r) { base.Deserialize(r); r.ReadInt(); _nextUse = r.ReadDateTime(); }
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            if (from.Skills[SkillName.Poisoning].Base < 100.0) { from.SendMessage("You need at least 100 Poisoning skill to use this bomb."); return; }
                ...
                Timer.DelayCall(TimeSpan.FromMilliseconds(10 * radius), delegate
                {
                    ...
                    for (int y = -radius; y <= radius; y++)
                    {
                        if (x * x + y * y <= radius * radius)
                        {
                            ...
                            Effects.SendLocationEffect(p, map, 0x11A6, 30, 10, 2511, 0);
                        }
                    }
                });
            }
        ...
        {
            private readonly PoisonCloudBomb _bomb;
            public ThrowTarget(PoisonCloudBomb b) : base(12, true, TargetFlags.None) { _bomb = b; }
