// ============================================================================
// File: Custom/Engineering/Grenadier/Bombs/Poison/UltraPoisonBomb.cs
// ============================================================================
using System;
...
{
    public partial class UltraPoisonBomb : Item
    {
        ...
        public UltraPoisonBomb(Serial s) : base(s) { }

        public virtual int MinDamage { get { return 60; } }
        public virtual int MaxDamage { get { return 110; } }
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            if (from.Skills[SkillName.Poisoning].Base < 110.0) { from.SendMessage("You need at least 110 Poisoning skill to use this bomb."); return; }
                ...
                Timer.DelayCall(TimeSpan.FromMilliseconds(10 * radius), delegate
                {
                    ...
                    for (int y = -radius; y <= radius; y++)
                        if (x * x + y * y <= radius * radius)
                            Effects.SendLocationEffect(new Point3D(loc.X + x, loc.Y + y, loc.Z), map, 0x11A6, 30, 10, 2511, 0);
                });
            }
        }
        ...
        {
            private readonly UltraPoisonBomb _bomb;
            public ThrowTarget(UltraPoisonBomb b) : base(12, true, TargetFlags.None) { _bomb = b; }
